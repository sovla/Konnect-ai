...
import { Trash2, AlertTriangle, ArrowLeft, User, Calendar, Package, DollarSign } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg">
              ...
              <div className="text-2xl font-bold text-green-900">{accountStats.totalEarnings.toLocaleString()}원</div>
            ...
            <div className="text-center p-4 bg-orange-50 rounded-lg">
              ...
              <div className="text-sm text-orange-700">최근 로그인</div>
            </div>
          </div>
        </div>
      )}
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    disabled={deleteConfirmText !== '계정삭제' || deleteAccountMutation.isPending}
